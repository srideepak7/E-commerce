...
const checkAdminPermissions = (role, action) => {
  const permissions = {
    [adminRoles.SUPER_ADMIN]: ['manage_sellers', 'manage_products', 'manage_orders'],
    [adminRoles.SELLER]: ['manage_products', 'manage_orders']
  };
